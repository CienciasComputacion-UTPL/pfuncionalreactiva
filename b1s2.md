...
Responda a las siguientes preguntas:
   ...
   1. ¿Es una función con nombre?
   2. ¿Cuántos parámetros recibe la función?
   3. ¿Cuál o cuáles son los tipos de datos de el o de los parámetros que recibe la función?
   4. ¿Cuál es el tipo de dato que devuelve la función?
   5. ¿El uso de las llaves es necesario? (Demuestren su respuesta)
   6. Qué salida genera la función si se invoca con los siguientes valores:
	   - Loja
	   - Universidad
	   - Particular
...
5. Ejecuten cada una de las funciones sin nombre, creadas en el punto 3, con los parámetros que se listan en el punto 2 y literal 6.
