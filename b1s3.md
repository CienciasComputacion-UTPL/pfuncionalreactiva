...
**Nota**: La función maxStudentByAge no recibe un parámetro, razón por la cual para que se pueda asignar a un valor se debe usar el operador __ también conocido como *eta-expansion*
...
Una vez que termine la primera parte (a lápiz y papel) debe presentar su trabajo a su docente para que registre la primera nota y le autorice a continuar con la segunda parte (última pregunta)
