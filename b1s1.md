...
La segunda, pídale al ChatGPT que transforme el código anterior, escrito de forma imperativa, a una versión funcional escrita para Python y Scala 3. Le sugiero incluir en el prompt el código Java anterior.
